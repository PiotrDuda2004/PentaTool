...
PentaTool is a Python program for searching public minecraft servers  
and checking with bot for whitelist. If there is no any, all whitelist-free servers will be added to your minecrfat servers list!  
